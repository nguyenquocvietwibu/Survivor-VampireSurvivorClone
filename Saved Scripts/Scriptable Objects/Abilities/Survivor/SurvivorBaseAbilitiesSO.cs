...
public class SurvivorBaseAbilitiesSO : SurvivorAbilitiesSO, ISurvivorBasicAbilitiees
{
    ...
    public void LevelUp()
    {
        levelUpAbilitySO.PerformLevelUp(survivor.statsManager.maxStatSO);
        survivor.statsManager.UpdateMaxStat();
    ...
    public IEnumerator ProcessInivicibility(float invicibilityTime)
    {
        ...
        Color originColor = survivor.spriteRenderer.color;
        while (true)
        {
            if (isDamaged)
            {
                ...
                canDamage = false;
                isDamaged = false;
                survivor.spriteRenderer.color = redColor;
            ...
            {
                survivor.spriteRenderer.color = originColor;
                yield return null;
            }
    ...
    {
        SurvivorBaseAbilitiesSO cloneBasicAbilitiesSO = ScriptableObject.CreateInstance<SurvivorBaseAbilitiesSO>();
