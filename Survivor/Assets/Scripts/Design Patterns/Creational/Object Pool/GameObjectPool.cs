...
/// <summary>
/// Lớp hồ game object cho phép tạo sẵn, gom nhóm, thu hồi cũng như trả ra các game object
/// </summary>
public class GameObjectPool : MonoBehaviour
{
    ...
    /// <summary>
    /// Phương thức lấy đối tượng game object ra ngoài hồ
    /// </summary>
    /// <param name="defaultPooledGO">Nếu không có đối tượng nào còn trong hồ thì tạo mới mặc định 1 pooled game object được truyền vào</param>
    /// <returns></returns>
